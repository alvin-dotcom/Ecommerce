...
const ProductClient = ({ initialData, slug }) => {
    ...
    const { product, products } = initialData;
    ...
    const description = Array.isArray(p.description) ? p.description.map(desc => desc.text || desc).join('\n\n') : p.description;
